...
public class RemoteWebDriver {
  ...
  */
  ...
  // JSON lib
  public static RemoteWebDriver getNewInstance(String json) {
    RemoteWebDriver request = new RemoteWebDriver();
    try {
  ...
  private static RemoteWebDriver parseGrid1Request(String clientRequest) {
  ...
  public static RemoteWebDriver localWebdriverNoCapabilities() {
    RemoteWebDriver res = build("-role", "webdriver","-host","localhost");
    res.capabilities.clear();
    return res;
  }

  public static RemoteWebDriver build(String... args) {
    RemoteWebDriver res = new RemoteWebDriver();
    res.args = args;
