...
public class SelendroidApp_Test {

    public static RemoteWebDriver driver;
    public static String applocation = "C:\\Users\\sjeyaram\\AppData\\Local\\Android\\sdk\\tools\\selendroid-test-app-0.16.0.apk";
    public static String appname = "selendroid-test-app-0.16.0.apk";
    ...
    @Test
    public void SelendroidApp_Sample_Test() throws InterruptedException {
	clickOnENBtn();
	clickOnChmBtn("Saivadurai");

    }

    public static void clickOnChmBtn(String EntName) {
    ...
    public static void clickOnENBtn() {
	WebElement ENButton = driver.findElement(By
		.className("android.widget.Button"));
	ENButton.click();
	driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
	WebElement EndActi_No = driver.findElement(By.id("android:id/button2"));
	EndActi_No.click();
