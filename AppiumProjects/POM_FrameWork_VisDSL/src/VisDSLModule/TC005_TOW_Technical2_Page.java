...
import AppModule.A005_Tow_Technical2_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC005_TOW_Technical2_Page {
    ...
    @Test(priority = 2)
    public void TOW_Technical2_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"Technical 2_Testdata");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A005_Tow_Technical2_Action.Execute(driver);
    }
