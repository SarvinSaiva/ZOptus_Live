...
import AppModule.A003_Tow_ScheduleItems_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC003_TOW_ScheduleItems_Page {
    ...
    @Test(priority = 2)
    public void TOW_ScheduleItems_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"ScheduleItems_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A003_Tow_ScheduleItems_Action.Execute(driver);
    }
