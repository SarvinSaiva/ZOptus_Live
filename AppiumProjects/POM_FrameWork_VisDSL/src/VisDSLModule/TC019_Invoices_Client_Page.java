...
import AppModule.A019_Invoices_Client_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC019_Invoices_Client_Page {
    ...
    @Test(priority = 1)
    public void Client_UnApproved_PAGE() throws Exception {
	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"Invoices_client_TestData");
	A019_Invoices_Client_Action INVC = new A019_Invoices_Client_Action();
	INVC.UnApproved_Client_Invoices(driver);

    }

    @Test(priority = 2)
    public void Client_Approved_PAGE() throws Exception {
	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"Invoices_client_TestData");
	A019_Invoices_Client_Action INVC = new A019_Invoices_Client_Action();
	INVC.Approved_Client_Invoices(driver);
