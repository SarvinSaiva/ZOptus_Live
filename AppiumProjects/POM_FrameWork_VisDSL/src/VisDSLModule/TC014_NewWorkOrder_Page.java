...
import AppModule.A014_NewWorkOrder_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC014_NewWorkOrder_Page {
    ...
    @Test(priority = 1)
    public void TOW_NewWorkOrder_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"NewWorkOrder_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A014_NewWorkOrder_Action.Execute(driver);
    }
