...
import AppModule.A008_Tow_NonStandInstall_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC008_TOW_NonStandInstall_Page {
    ...
    @Test(priority = 2)
    public void TOW_NonstandInstall_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"NonstandInstall_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A008_Tow_NonStandInstall_Action.Execute(driver);
    }
