...
import AppModule.A022_MyAccount_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC022_MyAccount_Page {
    ...
    @Test(priority = 1)
    public void TOW_MyAccount_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"MyAccount_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A022_MyAccount_Action.Execute(driver);
    }
