...
import AppModule.A012_Tow_Delete_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC012_TOW_Delete_Page {
    ...
    @Test(priority = 2)
    public void TOW_Delete_Page() throws Exception {

	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A012_Tow_Delete_Action.Execute(driver);
    }
