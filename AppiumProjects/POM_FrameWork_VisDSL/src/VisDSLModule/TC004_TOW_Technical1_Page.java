...
import AppModule.A004_Tow_Technical1_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC004_TOW_Technical1_Page {
    ...
    @Test(priority = 2)
    public void TOW_Technical1_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"Technical1_Testdata");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A004_Tow_Technical1_Action.Execute(driver);
    }
