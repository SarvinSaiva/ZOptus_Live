...
import AppModule.A009_Tow_Documentation_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC009_TOW_Documentation_Page {
    ...
    @Test(priority = 2)
    public void TOW_Documentation_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"Documentation_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A009_Tow_Documentation_Action.Execute(driver);
    }
