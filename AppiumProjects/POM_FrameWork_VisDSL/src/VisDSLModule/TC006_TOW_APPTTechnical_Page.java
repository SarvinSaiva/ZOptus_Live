...
import AppModule.A006_Tow_AAPTTechnical_Action;
import AppModule.WO_Action;
import Utility.Constant;
import Utility.ExcelUtils;

public class TC006_TOW_APPTTechnical_Page {
    ...
    @Test(priority = 2)
    public void TOW_APPTTechnical_Page() throws Exception {

	ExcelUtils.setExcelFile(
		Constant.Path_TestData + Constant.File_TestData,
		"AAPT_Tech_TestData");
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	A006_Tow_AAPTTechnical_Action.Execute(driver);
    }
