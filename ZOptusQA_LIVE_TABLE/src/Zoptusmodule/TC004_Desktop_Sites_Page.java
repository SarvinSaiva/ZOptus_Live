...
import appmodule.Desktop_Sites_Action;

public class TC004_Desktop_Sites_Page {

    WebDriver driver;
    public Exception Desktop_Sites_Page_Excp;

    @Test(priority = 1)
    public void Sites_SignIn() throws Exception {
    ...
    @Test(priority = 2)
    public void Sites_SiteDetails_Page() throws Exception {
	Desktop_Sites_Action SA = new Desktop_Sites_Action();
	SA.Sites_SiteDetails(driver);
    }

    @Test(priority = 3)
    public void Sites_SiteDocuments_Page() throws Exception {
	Desktop_Sites_Action SA = new Desktop_Sites_Action();
	SA.Sites_Sitedocuments(driver);
    }

    @Test(priority = 4)
    public void Sites_IssueRegister_Page() throws Exception {
	Desktop_Sites_Action SA = new Desktop_Sites_Action();
	SA.Sites_IssueRegister(driver);
    }

    @Test(priority = 5)
    public void Sites_Faults_Page() throws Exception {
	Desktop_Sites_Action SA = new Desktop_Sites_Action();
	SA.Sites_Faults(driver);
    }
	...
	try {
	    ...
	    jm.TC004_Desktop_Sites_Page_Exception(e);
