...
import appmodule.Mobility_Documents_Action;
import appmodule.Mobility_SignIn_Action;

public class TC013_Mobility_Documents_Page {

    WebDriver driver;
    public Exception Mobility_Documents_Page_Excp;

    @Test(priority = 1)
    public void Documents_SignIn() throws Exception {
    ...
    @Test(priority = 2)
    public void Dashboard_Documents_Search() throws Exception {
	Mobility_Dashboard_Action MDB = new Mobility_Dashboard_Action();
	MDB.Dashboard_Search(driver);
    }

    @Test(priority = 3)
    public void Documents_Menu() throws Exception {
	Mobility_Documents_Action MDD = new Mobility_Documents_Action();
	MDD.Documents_Menu(driver);
    }
	...
	try {
	    ...
	    JM.TC013_Mobility_Documents_Page_Exception(e);
