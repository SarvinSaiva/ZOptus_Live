...
import appmodule.Mobility_WorkMaterials_Action;

public class TC015_Mobility_WorkMaterials_Page {
    WebDriver driver;
    public Exception Mobility_WorkMaterials_Page_Excp;

    @Test(priority = 1)
    public void WorkMaterials_SignIn() throws Exception {
    ...
    @Test(priority = 2)
    public void Dashboard_WorkMaterials_Search() throws Exception {
	Mobility_WorkMaterials_Action MWM = new Mobility_WorkMaterials_Action();
	MWM.WorkMaterials_Search(driver);
    }

    @Test(priority = 3)
    public void Workmaterials_Menu() throws Exception {
	Mobility_WorkMaterials_Action MWM = new Mobility_WorkMaterials_Action();
	MWM.WorkMaterials_Menu(driver);
    }
	...
	try {
	    ...
	    jm.TC015_Mobility_WorkMaterials_Page_Exception(e);
