...
import appmodule.Mobility_WorkMilestones_Action;

public class TC016_Mobility_WorkMilestones_Page {

    WebDriver driver;
    public Exception Mobility_WorkMilestones_Page_Excp;
    ...
    @Test(priority = 2)
    public void Dashboard_WorkMilestones_Search() throws Exception {
	Mobility_Dashboard_Action MDB = new Mobility_Dashboard_Action();
	MDB.Dashboard_Search(driver);
    }

    @Test(priority = 3)
    public void WorkMilestones_Menu() throws Exception {
	Mobility_WorkMilestones_Action MWT = new Mobility_WorkMilestones_Action();
	MWT.WorkMilestones_Menu(driver);
    }
	...
	try {
	    ...
	    JM.TC016_Mobility_WorkMilestones_Page_Exception(e);
